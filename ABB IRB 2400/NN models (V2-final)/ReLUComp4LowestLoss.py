...
relu_files = [
    "ReLU(10,10,10)/metadata.json",
    "ReLU(100,100,100)/metadata.json",
    "ReLU(1000,1000,1000)/metadata.json",
    "ReLU(1000,1000,1000,1000)/metadata.json",
    "ReLU(1000,1000,1000,1000,1000)/metadata.json",
    "ReLU(1000,1000,1000,1000,1000,1000)/metadata.json"
]
...
def plot_all_relu_sets(relu_data):
    ...
    plt.title("Comparison of All ReLU Configurations")
    plt.xlabel("Epoch")
