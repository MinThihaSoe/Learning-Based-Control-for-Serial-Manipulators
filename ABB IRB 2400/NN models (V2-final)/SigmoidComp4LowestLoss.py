...
relu_files = [
    "Sigmoid(10,10,10)/metadata.json",
    "Sigmoid(100,100,100)/metadata.json",
    "Sigmoid(1000,1000,1000)/metadata.json",
    "Sigmoid(1000,1000,1000,1000)/metadata.json",
    "Sigmoid(1000,1000,1000,1000,1000)/metadata.json",
    "Sigmoid(1000,1000,1000,1000,1000,1000)/metadata.json"
]
...
def plot_all_relu_sets(relu_data):
    ...
    plt.title("Comparison of All Sigmoid Configurations")
    plt.xlabel("Epoch")
